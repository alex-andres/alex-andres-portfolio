...
const aboutCardData = [
  {
    ...
    src: consultation,
    body: [
      "I’m a web developer from Pasadena, CA. Being raised by parents who both were teachers (math and art), I have always had the passion for learning, visual creativity and logical problem solving, passions that are well satisfied by web development.",
